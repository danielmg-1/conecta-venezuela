...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Esta no es una emergencia de un fin de semana. La magnitud de esta catástrofe nos necesitará durante semanas e incluso meses." },
      { name: "author", content: "Conecta Venezuela" },
      { property: "og:title", content: "Conecta Venezuela — Guía de apoyo tras el terremoto" },
      { property: "og:description", content: "Esta no es una emergencia de un fin de semana. La magnitud de esta catástrofe nos necesitará durante semanas e incluso meses." },
